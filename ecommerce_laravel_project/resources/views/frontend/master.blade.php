                            ...
                            @auth('customerlogin')
                                <div class="dropdown">
                                    <a class="dropdown-toggle" type="button" id="dropdownMenuButton" data-toggle="dropdown"
                                        ...
                                        <i class="lni lni-user mr-1"></i>&nbsp;{{ Auth::guard('customerlogin')->user()->name }}
                                    </a>
                ...
                <div class="right-ch-sideBar">
                    ...
                    <div class="cart_select_items py-2">
                        ...
                        <div class="d-flex align-items-center justify-content-between br-bottom px-3 py-3">
                            <div class="cart_single d-flex align-items-center">
                                <div class="cart_selected_single_thumb">
                                    <a href="#"><img src="{{asset('uploads/product/preview')}}/{{$cart->rel_to_product->preview}}" width="60"
                                            class="img-fluid" alt="" /></a>
                                </div>
                                <div class="cart_single_caption pl-2">
                                    <h4 class="product_title fs-sm ft-medium mb-0 lh-1">{{$cart->rel_to_product->product_name}}</h4>
                                    <p class="mb-2"><span class="text-dark ft-medium small">{{$cart->size_id==null?'':$cart->rel_to_size->size_name}}</span> {{$cart->size_id==null?'':','}}<span
                                            class="text-dark small">{{$cart->color_id==null?'':$cart->rel_to_color->color_name}}</span></p>
