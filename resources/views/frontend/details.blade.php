                    ...
                    <div class="quick_view_slide">
                        @foreach ($thumbnails as $thumb)
                            <div class="single_view_slide"><a
                                    href="{{ asset('uploads/product/thumbnail') }}/{{ $thumb->thumbnail }}"
                                ...
                                <div class="text-left">
                                    ...
                                    <div class="elis_rty">
                                        @if ($product_info->first()->discount)
                                            <span
                                                class="ft-medium text-muted line-through fs-md mr-2">TK{{ $product_info->first()->price }}</span>
                                        @endif
                                        <span class="ft-bold theme-cl fs-lg mr-2">TK
                                            {{ $product_info->first()->after_discount }}</span>
                                    </div>
                                </div>
                            </div>
                            ...
                            {{-- <div class="prt_04 mb-4">
                                ...
                                <div class="text-left pb-0 pt-2 size_id">
                                    @if ($available_sizes == 1)
                                        <h5 class="text-danger">Size Not available</h5>
                                    @else
