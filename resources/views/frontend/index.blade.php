                        ...
                        <div class="killore--block-link-content">
                            <ul>
                                @foreach ($categories as $category)
                                    <li><a href="javascript:void(0);"><i class=""><img width="20"
                                                    src="{{ asset('uploads/category') }}/{{ $category->category_image }}"
                                                    alt=""></i>{{ $category->category_name }}</a></li>
                                @endforeach
                            </ul>
                        </div>
                    </div>
                                ...
                                <div class="text-left">
                                    <div class="text-left">
                                        <div class="elso_titl"><span
                                                class="small">{{ $product->rel_to_category->category_name }}</span></div>
                                        ...
                                        <div class="elis_rty">
                                            @if ($product->discount)
                                                <span
                                                    class="ft-muted text-dark fs-md mr-2 line-through">Tk{{ $product->price }}</span>
                                            @endif
                    ...
                    <div class="ftr-content">
                        ...
                        <div class="product_grid row">
                            <div class="col-xl-4 col-lg-5 col-md-5 col-4">
                                <div class="shop_thumb position-relative">
                                    <a class="card-img-top d-block overflow-hidden" href="shop-single-v1.html"><img
                                            class="card-img-top" src="{{asset('uploads/product/preview')}}/{{$feat_product->preview}}" alt="..."></a>
                                </div>
                            </div>
                            <div class="col-xl-8 col-lg-7 col-md-7 col-8 pl-0">
                                <div class="text-left mfliud">
                                    ...
                                    <div class="elis_rty"> @if ($feat_product->discount)
                                        <span
                                            class="ft-muted text-dark fs-md mr-2 line-through">Tk{{ $product->price }}</span>
                                    @endif
                                    <span class="ft-bold text-dark fs-sm">Tk {{ $feat_product->after_discount }}</span></div>
                                </div>
                            </div>
                        </div>
                        @endforeach
