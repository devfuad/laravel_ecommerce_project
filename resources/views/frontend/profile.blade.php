        ...
        <div class="container">
            <div class="row align-items-start justify-content-between">
                ...
                <div class="col-12 col-md-12 col-lg-8 col-xl-8">
                    <!-- row -->
                    @if (session('s_update'))
                    <div class="alert alert-success">{{session('s_update')}}</div>
                        ...
                        <form class="row m-0" action="{{ route('profile.update') }}" method="POST"
                            ...
                            <div class="col-xl-6 col-lg-6 col-md-12 col-sm-12">
                                <div class="form-group">
                                    ...
                                    @if (session('wrong_pass'))
                                        <div class="alert alert-warning">{{session('wrong_pass')}}</div>
                                    @endif
                            ...
                            <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12">
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control" name="country" value="{{Auth::guard('customerlogin')->user()->country}}" placeholder="Country"/>
                                </div>
                            </div>
                            <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12">
                                <div class="form-group">
