                    ...
                    <div class="d-block border rounded mfliud-bot">
                        <div class="dashboard_author px-2 py-5">
                            <div class="dash_auth_thumb circle p-1 border d-inline-flex mx-auto mb-2">
                                ...
                                @else
                                    <img width="100" height="100" class="circle"
                                        src="{{ asset('uploads/customer') }}/{{ Auth::guard('customerlogin')->user()->photo }}" />
                                @endif
                                        ...
                                        <div class="col-xl-12 col-lg-12 col-md-12 col-12">
                                            <div class="cart_single d-flex align-items-start">
                                                ...
                                                <div class="cart_single_caption pl-3">
                                                    ...
                                                    <p class="mb-2"><span class="text-dark medium">Size: {{$product->rel_to_size->size_name}}</span>, <span
                                                            class="text-dark medium">Color: {{$product->rel_to_color->color_name}}</span></p>
                                                    <h4 class="fs-sm ft-bold mb-0 lh-1">TK {{$product->rel_to_product->after_discount}} X {{$product->quantity}} </h4>
                                                </div>
                                            </div>
                                        </div>
