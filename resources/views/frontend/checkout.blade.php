                            ...
                            <div class="col-xl-6 col-lg-6 col-md-6 col-sm-6 col-12">
                                <div class="form-group">
                                    ...
                                    <input type="email" name="email"
                                        value="{{ Auth::guard('customerlogin')->user()->email }}" class="form-control"
                                        placeholder="Email" />
                                </div>
                            </div>
                ...
                <div class="col-12 col-lg-4 col-md-12">
                    ...
                    <div class="mb-4">
                        <div class="form-group">
                            ...
                            <ul class="no-ul-list">
                                <li>
                                    <input id="c1" class="radio-custom charge" name="charge" value="70"
                                        type="radio">
                                    <label for="c1" class="radio-custom-label">Inside City</label>
                                </li>
                                <li>
                                    <input id="c2" class="radio-custom charge" name="charge" value="100"
                                        type="radio">
                        ...
                        <div class="card-body">
                            <ul class="list-group list-group-sm list-group-flush-y list-group-flush-x">
                                <li class="list-group-item d-flex text-dark fs-sm ft-regular">
                                    <span>Subtotal</span> <span class="ml-auto text-dark ft-medium ">TK <span
                                            class="sub_total">
